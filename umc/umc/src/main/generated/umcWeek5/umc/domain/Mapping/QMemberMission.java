...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 1892514563L;
    ...
    public final umcWeek5.umc.domain.QMember member;

    public final umcWeek5.umc.domain.QMission mission;

    public final EnumPath<umcWeek5.umc.domain.enums.MissionStatus> status = createEnum("status", umcWeek5.umc.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new umcWeek5.umc.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new umcWeek5.umc.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
