...
public class QMemberPreferFood extends EntityPathBase<MemberPreferFood> {
    ...
    private static final long serialVersionUID = -1501091401L;
    ...
    public final umcWeek5.umc.domain.QFoodCategory foodCategory;
    ...
    public QMemberPreferFood(Class<? extends MemberPreferFood> type, PathMetadata metadata, PathInits inits) {
        ...
        this.foodCategory = inits.isInitialized("foodCategory") ? new umcWeek5.umc.domain.QFoodCategory(forProperty("foodCategory")) : null;
